        ...
        try:
            ...
            if applicant_data["selectedTemplate"] == 3:
                ...
                try:
                    ...
                    urllib.request.urlretrieve(image_url, f"/home/Ad30/ShareAPI/apis/pdfs/{image_name}")
                    image = Image.open(f"/home/Ad30/ShareAPI/apis/pdfs/{image_name}")
                    target_width = 100
                    original_width, original_height = image.size
                    target_height = int((target_width / original_width) * original_height)
                    resized_image = image.resize((target_width, target_height))
                    resized_image.save(f"/home/Ad30/ShareAPI/apis/pdfs/{image_name}")
                    image.close()
            ...
            def generate_pdf():
                ...
                pdf_path = f'/home/Ad30/ShareAPI/apis/pdfs/{pdf_name}'
            ...
            if isinstance(pdf_name_or_response, Response):
                ...
                file = f'/home/Ad30/ShareAPI/apis/pdfs/{pdf_name_or_response}{pdf_ex}'
                response = FileResponse(open(file, 'rb'), as_attachment=True, filename="resume.pdf")
                if applicant_data["selectedTemplate"] == 3:
                    os.remove(f"/home/Ad30/ShareAPI/apis/pdfs/{image_name}")
                    os.remove(file)
                else:
                    os.remove(file)
